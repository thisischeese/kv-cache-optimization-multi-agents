...
# Keeps prompts bounded; a page-sized chunk is usually shorter than this.
...
EXTRACT_SYSTEM = (
    ...
    "numbers only in passage_numbers, never in the text. If the passages do not "
    "contain the target information, return an empty list. Write at most 5 "
...
VERIFY_SYSTEM = (
    ...
    "imply', 'possibly', 'might') is unsupported. Plain paraphrase is fine, and so "
    "is calling a cost the passage states an overhead. Give a verdict for every point; "
