...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate Qdrant retrieval with simple relevance labels")
...
def main() -> None:
    ...
    for case in cases:
        ...
        print(f"{case.name}: recall@{args.top_k}={result.recall_at_k:.3f} rr={result.reciprocal_rank:.3f} first_rank={rank}")
